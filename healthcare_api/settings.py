...
ALLOWED_HOSTS = config('ALLOWED_HOSTS', default='localhost,127.0.0.1,new.avishifo.uz,.avishifo.uz', cast=lambda v: [s.strip() for s in v.split(',')])
...
MIDDLEWARE = [
    ...
    'healthcare_api.middleware.CustomCorsMiddleware',  # Custom CORS middleware
]
