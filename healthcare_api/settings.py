...
ALLOWED_HOSTS = config('ALLOWED_HOSTS', default='localhost,127.0.0.1,new.avishifo.uz,.avishifo.uz,217.114.6.143,api.avishifo.4mi.uz', cast=lambda v: [s.strip() for s in v.split(',')])
...
MIDDLEWARE = [
    ...
    'healthcare_api.cors_middleware.CustomCorsMiddleware',
