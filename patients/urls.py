...
from .views import (
    PatientCreateAPIView, PatientListAPIView, PatientListView, PatientDetailView, PatientCreateView, PatientRetrieveAPIView,
...
urlpatterns = [
    ...
    path('patients/<int:id>/', PatientRetrieveAPIView.as_view(), name='patient-detail'),
